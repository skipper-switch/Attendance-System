...
export default function AdminStudentsPage() {
  return (
    <div className="max-w-[1440px] w-full mx-auto pb-10 relative">
      ...
      {/* <div className="fixed top-20 right-8 z-50 flex items-center gap-3 bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-xl shadow-lg animate-in fade-in slide-in-from-top-4 duration-300">
        <div className="w-8 h-8 rounded-full bg-emerald-500 flex items-center justify-center text-white">
          <span className="material-symbols-outlined text-lg" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
        </div>
        <div>
          <p className="font-bold text-sm">Student created successfully!</p>
          <p className="text-xs opacity-90">Ada Okafor can now log in.</p>
        </div>
        <button className="ml-4 text-emerald-400 hover:text-emerald-600">
