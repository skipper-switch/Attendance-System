    ...
    <div className="max-w-[1440px] mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-[0px_4px_6px_-1px_rgba(15,23,42,0.05)]">
          ...
          <div className="flex flex-col">
            <span className="text-slate-500 text-[11px] tracking-widest uppercase font-bold">
              Overall Attendance
            </span>
            <span
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Performance tracking for the last 3 months
              </p>
            </div>
          ...
          <div className="flex items-end justify-between h-64 pt-8 px-12 border-b border-slate-100">
            ...
            <div className="group relative flex flex-col items-center w-24">
              <div
                ...
                style={{ height: "88%" }}
              />
              <span className="absolute -top-8 bg-slate-900 text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                88%
              </span>
            ...
            <div className="group relative flex flex-col items-center w-24">
              <div
                className="w-full bg-amber-400 rounded-t-lg transition-all hover:brightness-110"
                style={{ height: "72%" }}
              />
              <span className="absolute -top-8 bg-slate-900 text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                72%
            ...
            {recentActivity.length === 0 ? (
              ...
              recentActivity.map((record: AttendanceRecord) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`h-10 w-10 rounded-full ${style.bg} flex items-center justify-center ${style.text} shrink-0`}
                    >
                    ...
                    <span
                      className={`text-[10px] font-bold uppercase px-2 py-1 ${style.badge} rounded-full shrink-0`}
                    >
                      {record.status}
                    </span>
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-indigo-600 rounded-xl p-8 text-white relative overflow-hidden group">
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 text-sm mb-6">
              You&apos;ve completed {attendancePct}% of your current module&apos;s
        ...
        <div className="bg-white border border-slate-200 p-8 rounded-xl flex items-center gap-6">
          ...
          <div>
            <span className="text-amber-600 text-[10px] font-bold uppercase">
              Reminder
            </span>
            <h4
